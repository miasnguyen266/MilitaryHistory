...
export default function AdminFigures() {
  ...
  const indexOfLast = currentPage * figuresPerPage;
  const indexOfFirst = indexOfLast - figuresPerPage;
  const currenFigures = figures.slice(indexOfFirst, indexOfLast);

  const totalPages = Math.ceil(figures.length / figuresPerPage);
