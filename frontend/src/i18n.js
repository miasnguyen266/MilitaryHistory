...
const resources = {
  vi: {
    translation: {
      ...
      "footer.museum.title": "Bảo Tàng Lịch Sử Quân Sự Việt Nam",
      "footer.museum.intro":
        "Nơi lưu giữ và tôn vinh những giá trị lịch sử, văn hóa và truyền thống anh hùng của dân tộc.",
      "footer.museum.address":
        "Km 6+500 Đại lộ Thăng Long, phường Tây Mỗ và Đại Mỗ, quận Nam Từ Liêm, thành phố Hà Nội",
      "footer.military_museums.title": "Các bảo tàng quân sự tiêu biểu",
      "footer.connect": "Kết nối với chúng tôi",
      "footer.hotline": "028 3824 9999",
      "footer.email": "baotanglichsuquansuvietnam@gmail.com",
      "footer.hours": "Giờ mở cửa: 8:00 – 16:30 (Thứ 3 – 5, Thứ 7-CN)",
      "footer.copyright":
        "© {year} Bảo Tàng Lịch Sử Quân Sự Việt Nam. All rights reserved.",
      "footer.view_location": "Xem vị trí đầy đủ trên Google Maps →",
      "footer.address_label": "Địa chỉ chính",
      "footer.hotline_label": "Hotline",
      "footer.email_label": "Email",
      "footer.museum_name": "Bảo tàng Lịch sử Quân sự Việt Nam",
  ...
  en: {
    translation: {
      ...
      "footer.museum.title": "Military History Museum of Vietnam",
      "footer.museum.intro":
        "A place that preserves and honors the historical, cultural and heroic values of our nation.",
      "footer.museum.address":
        "Km 6+500 Thang Long Boulevard, Tay Mo and Dai Mo wards, Nam Tu Liem district, Hanoi",
      "footer.military_museums.title": "Typical military museums",
      "footer.connect": "Connect with us",
      "footer.hotline": "028 3824 9999",
      "footer.email": "baotanglichsuquansuvietnam@gmail.com",
      "footer.hours": "Open hours: 8:00 – 16:30 (Tue – Fri, Sat-Sun)",
      "footer.copyright":
        "© {year} Military History Museum of Vietnam. All rights reserved.",
      "footer.view_location": "View full location on Google Maps →",
      "footer.address_label": "Main Address",
      "footer.hotline_label": "Hotline",
      "footer.email_label": "Email",
      "footer.museum_name": "Military History Museum of Vietnam",
